...
```{r echo=FALSE, fig.cap="List of all industries using the first two digits of the NAICS code", fig.width=3, fig.length=5,      fig.align = "center"}
...
```{r echo=FALSE, fig.cap="List of all industries using the first two digits of the NAICS code and the corresponding loan default rates", fig.width=3, fig.length=5,      fig.align = "center"}
